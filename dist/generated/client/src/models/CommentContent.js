...
export function CommentContentFromJSON(json) {
    return CommentContentFromJSONTyped(json, false);
}
export function CommentContentFromJSONTyped(json, ignoreDiscriminator) {
...
export function CommentContentToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
