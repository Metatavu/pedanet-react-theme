...
* @enum {string}
*/
export var InlineObject3StatusEnum;
(function (InlineObject3StatusEnum) {
    InlineObject3StatusEnum["Publish"] = "publish";
    InlineObject3StatusEnum["Future"] = "future";
    InlineObject3StatusEnum["Draft"] = "draft";
    InlineObject3StatusEnum["Pending"] = "pending";
    InlineObject3StatusEnum["Private"] = "private";
})(InlineObject3StatusEnum || (InlineObject3StatusEnum = {}));
/**
* @export
* @enum {string}
*/
export var InlineObject3CommentStatusEnum;
(function (InlineObject3CommentStatusEnum) {
    InlineObject3CommentStatusEnum["Open"] = "open";
    InlineObject3CommentStatusEnum["Closed"] = "closed";
})(InlineObject3CommentStatusEnum || (InlineObject3CommentStatusEnum = {}));
/**
* @export
* @enum {string}
*/
export var InlineObject3PingStatusEnum;
(function (InlineObject3PingStatusEnum) {
    InlineObject3PingStatusEnum["Open"] = "open";
    InlineObject3PingStatusEnum["Closed"] = "closed";
})(InlineObject3PingStatusEnum || (InlineObject3PingStatusEnum = {}));
