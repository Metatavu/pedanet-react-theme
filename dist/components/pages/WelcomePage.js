    ...
    function WelcomePage(props) {
        ...
        _this.columnsRendered = function () {
            ...
            return columns.map(function (column) {
                return (React.createElement("div", { className: "".concat(classes.column, " ").concat(column.props.className) }, column.props.children.map(function (child) {
                    return child;
                })));
            });
        };
        ...
        _this.wpColumnParsing = function (node, index) {
            ...
            columnsDividedToTwo.forEach(function (item) {
                if (item.children) {
                    columnsDividedTwiceToTwo = __spreadArray(__spreadArray([], columnsDividedTwiceToTwo, true), item.children.filter(function (child) { return child.attribs && child.attribs.class && child.attribs.class.match("wp-block-column"); }), true);
                }
            });
            var columnsDividedToFour = [];
            columnsDividedTwiceToTwo.forEach(function (item) {
                if (item.children) {
                    columnsDividedToFour = __spreadArray(__spreadArray([], columnsDividedToFour, true), item.children.filter(function (child) { return child.attribs && child.attribs.class && child.attribs.class.match("wp-block-column"); }), true);
                }
            });
    ...
    WelcomePage.prototype.render = function () {
        ...
        return (React.createElement(BasicLayout, { lang: lang, frontPage: true },
            React.createElement(Container, { style: { marginBottom: 50 }, fixed: true },
                React.createElement("div", { style: { display: "flex", flexDirection: "row", justifyContent: "flex-end" } },
                    React.createElement("div", { id: "readspeaker_button1", className: "rs_skip rsbtn rs_preserve", style: { maxWidth: "fit-content" } },
                ...
                React.createElement("div", { className: "".concat(classes.frontPageText, " readthis") }, this.state.textSection),
                React.createElement("div", { className: "".concat(classes.columnSection, " readthis"), role: "heading", "aria-level": 1 }, this.renderColumns()))));
    };
    /**
     * Hide page loader
     */
