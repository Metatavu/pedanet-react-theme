...
var PostPage = /** @class */ (function (_super) {
    ...
    function PostPage(props) {
                    ...
                    case 0:
                        ...
                        buildPath_1 = function (current) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        title = current.title ? "" + current.title.rendered : "";
                                        link = "" + current.link;
                                        breadcrumb_1 = __spreadArrays([{ label: title, link: link }], breadcrumb_1);
                                        if (!(current.parent !== undefined && current.parent !== 0)) return [3 /*break*/, 3];
                                        parentId = current.parent;
                                        return [4 /*yield*/, api_1.getWpV2PagesById({ id: "" + parentId })];
                                    case 1:
                                        parent_1 = _a.sent();
        ...
        _this.setTitleSource = function () {
            ...
            var noContentError = "" + strings.whoops;
            var undefinedContentError = "" + strings.error;
            if (pageTitle) {
                ...
                React.createElement("div", { className: classes.pageContent },
                    React.createElement("div", { className: classes.breadcrumb },
                        ...
                        React.createElement("div", { id: "readspeaker_button1", className: "rs_skip rsbtn rs_preserve" },
                            React.createElement("a", { rel: "nofollow", className: "rsbtn_play", accessKey: "L", title: "Kuuntele", href: "//app-eu.readspeaker.com/cgi-bin/rsent?customerid=" + readSpeakerId + "&amp;lang=fi_fi&amp;readclass=readthis&amp;url=" + encodeURIComponent(window.location.href) },
                    ...
                    React.createElement("div", { className: classes.columns },
                        React.createElement(Hidden, { smDown: true },
                            React.createElement("div", { className: classes.leftsidebar + " " + classes.noPrint, role: "navigation", "aria-label": "nav wrapper" },
                        ...
                        React.createElement(Hidden, { mdUp: true },
                            React.createElement(Collapse, { in: showMobileMenu },
                                React.createElement("div", { className: classes.leftsidebar + " " + classes.noPrint, role: "navigation", "aria-label": "nav wrapper" },
                                    React.createElement(TreeView, { lang: lang, slug: slug })))),
                        React.createElement("div", { className: classes.contentArea + " readthis" }, this.renderContent()),
