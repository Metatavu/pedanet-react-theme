    ...
    function SearchResultsPage(props) {
        ...
        _this.renderPageNavigation = function () {
            ...
            return (React.createElement("div", { style: { display: "flex", flexDirection: "row", justifyContent: "center", fontSize: "1.6rem", marginTop: "20px", marginBottom: "20px" } },
                previousPageElement,
                " ",
                React.createElement("span", { style: { marginLeft: "10px", marginRight: "10px" } }, strings.page + " " + _this.state.currentPage),
                " ",
                nextPageElement));
        };
        /**
        ...
        _this.renderResult = function (result) {
            return (React.createElement("div", { style: {
                ...
                result.placeholderImage ? React.createElement("img", { style: { alignSelf: "center" }, src: result.imageUrl, width: 120, height: 60 }) : React.createElement("img", { src: result.imageUrl, width: 120, height: 120 }),
    ...
    SearchResultsPage.prototype.render = function () {
        ...
        return (React.createElement(BasicLayout, { lang: this.props.lang },
            React.createElement(Container, { fixed: true },
                ...
                React.createElement(TextField, { size: "small", style: { width: "100%", marginBottom: "10px" }, onChange: function (event) { return _this.setState({ query: event.target.value }); }, value: this.state.query, variant: "outlined" }),
