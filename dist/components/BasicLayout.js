            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        eventCalendarUrl = window.location.origin + "/koulutuskalenteri/";
                        api = ApiUtils.getApi();
    ...
    BasicLayout.prototype.render = function () {
        ...
        return (React.createElement("div", { className: classes.root },
            React.createElement("div", { className: classes.noPrint, role: "navigation", "aria-label": "top nav" },
                React.createElement("div", { className: classes.horizontalColorBar, "aria-label": "top bar", style: { backgroundImage: "url( " + bar + " )" } }),
            ...
            React.createElement("div", { role: "banner", className: classes.logoBar + " " + classes.headerImage + " " + classes.noPrint, style: { backgroundImage: "url(" + (this.state.loading ? "" : postThumbnail) + ")" } }),
            this.props.children,
