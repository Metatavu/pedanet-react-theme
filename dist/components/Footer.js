...
var Footer = /** @class */ (function (_super) {
    ...
    Footer.prototype.render = function () {
        ...
        return (React.createElement("div", { className: classes.noPrint },
            React.createElement(Grid, { container: true, justifyContent: "space-around", style: { backgroundColor: "#234c8e", marginTop: "50px" } },
                React.createElement(Grid, { className: classes.footerContainer, container: true, lg: 8, md: 12, sm: 12 }, this.renderColumns())),
            React.createElement("img", { alt: "Banner", style: { height: "8px", width: "100%" }, src: "https://mikkeli.fi/gfx/layout/mikkeli-banner-border.png" })));
    };
    return Footer;
}(React.Component));
