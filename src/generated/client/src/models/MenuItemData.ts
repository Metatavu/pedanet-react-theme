...
export interface MenuItemData {
     ...
     * @memberof MenuItemData
     */
    child_items?: Array<MenuItemData>;
}

export function MenuItemDataFromJSON(json: any): MenuItemData {
    return MenuItemDataFromJSONTyped(json, false);
}

export function MenuItemDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): MenuItemData {
    ...
    return {
        ...
        'child_items': !exists(json, 'child_items') ? undefined : (json['child_items'] as Array<any>).map(MenuItemDataFromJSON),
    };
}

export function MenuItemDataToJSON(value?: MenuItemData | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'child_items': value.child_items == null ? undefined : (value.child_items as Array<any>).map(MenuItemDataToJSON),
    };
}
