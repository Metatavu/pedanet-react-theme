 ...
 * 
 * @export
 * @interface WpBlockRevision
 */
export interface WpBlockRevision {
    /**
     * The ID for the author of the object.
     * @type {number}
     * @memberof WpBlockRevision
     */
    author?: number;
    /**
...
export function WpBlockRevisionFromJSON(json: any): WpBlockRevision {
    return WpBlockRevisionFromJSONTyped(json, false);
}

export function WpBlockRevisionFromJSONTyped(json: any, ignoreDiscriminator: boolean): WpBlockRevision {
...
export function WpBlockRevisionToJSON(value?: WpBlockRevision | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
